...
| **Survival Players** | Use YZ tools, advancement system, teleport anchors, and mana staves for gameplay |
...
│   ├── mana/                             # Mana system
│   ├── mixin/                            # Main Mixins (Guardian Heart, invis containers/particles/sounds)
│   ├── network/                          # Network packets (14 total)
...
│   ├── mixin/client/                     # Client Mixins (title, options, pause, chat, loading, etc.)
