...
| **Survival Players** | Use Youzai tools, advancement system, teleport anchors, sit interaction, and mana staves for gameplay |
...
- **World Generation**: Teleport anchor ruins naturally generate in the Overworld (14 biomes including forests/taiga/mountains/plains/swamps, 28-chunk spacing), Nether (18-chunk spacing), and End (end highlands/midlands, 22-chunk spacing) — data-driven, powered by Moog's Structure Lib
