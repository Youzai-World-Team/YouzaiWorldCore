# 定义记分板
scoreboard objectives add youzaiworld.death deathCount "死亡次数"
...
scoreboard objectives add youzaiworld.heart_count dummy "守护之心数量"
scoreboard objectives add youzaiworld.heart_warned dummy "守护之心警告等级"
...
# 守护之心警告等级初始化
scoreboard players set @a youzaiworld.heart_warned 0
