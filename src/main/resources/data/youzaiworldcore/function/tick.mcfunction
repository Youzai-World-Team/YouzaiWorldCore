...
# 新手教程、区分玩家状态逻辑
# 检测重进玩家：leave_game > last_leave 且 status 1~10
execute as @a[scores={beginner_tutorial_status=1..10}] if score @s leave_game > @s last_leave run function youzaiworldcore:beginner_tutorial
