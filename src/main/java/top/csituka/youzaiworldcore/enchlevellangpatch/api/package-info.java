 ...
 *     {@link top.csituka.youzaiworldcore.enchlevellangpatch.api.EnchantmentLevelLangPatch#registerPatch}(
 ...
 *     };
 *     {@link top.csituka.youzaiworldcore.enchlevellangpatch.api.EnchantmentLevelLangPatch#registerEnchantmentPatch}("my_mod_id:thai_numbers", patch);
 *     // If you want to apply it immediately:
 *     {@link top.csituka.youzaiworldcore.enchlevellangpatch.api.EnchantmentLevelLangPatchConfig#setCurrentEnchantmentHooks}(patch);
 * </pre></blockquote>
 *
 * <h3>Note: 1.19.4+ implementation</h3>
 * <p>Since Minecraft 1.19.4, the game invokes the patch {@link top.csituka.youzaiworldcore.enchlevellangpatch.api.EnchantmentLevelLangPatch#apply(java.util.Map, java.lang.String, java.lang.String)
 * <b>with</b> fallback} (instead of the one {@link top.csituka.youzaiworldcore.enchlevellangpatch.api.EnchantmentLevelLangPatch#apply(java.util.Map, java.lang.String)
 * <b>without</b> fallback}).</p>
 * <p>You can use {@link top.csituka.youzaiworldcore.enchlevellangpatch.api.EnchantmentLevelLangPatch#withFallback} to create a patch if
 * you want to apply your patch <b>only</b> in Minecraft 1.19.4+.</p>
 *
 * <h3>Mod entrypoint</h3>
 * <p>Your patches should be registered in YouzaiWorldCore client initialization.</p>
 */
package top.csituka.youzaiworldcore.enchlevellangpatch.api;
