...
/**
 * 九大预设潜影盒生成工具类。
 * 整合 godlygearbox (毕业套装) 模组的 9 个预设。
 *
 * <p>
 * 直接在创造模式标签页中调用这些方法即可生成带有丰富附魔和物品的预设潜影盒，
 * 无需注册额外物品 ID。
 * </p>
 */
...
public class PresetItems {
        ...
        public static ItemStack createPreset01(HolderLookup.Provider lookup) {
                ...
                items.add(ench(Items.NETHERITE_HELMET, lookup,
                                Enchantments.PROTECTION, 4, Enchantments.BLAST_PROTECTION, 4,
                ...
                items.add(ench(Items.NETHERITE_BOOTS, lookup,
                                Enchantments.PROTECTION, 4, Enchantments.BLAST_PROTECTION, 4,
                                Enchantments.FIRE_PROTECTION, 4,
                                Enchantments.PROJECTILE_PROTECTION, 4, Enchantments.FEATHER_FALLING, 4,
                ...
                items.add(ench(Items.NETHERITE_SPEAR, lookup,
                                ...
                                Enchantments.BANE_OF_ARTHROPODS, 5, Enchantments.FIRE_ASPECT, 2, Enchantments.LOOTING,
                                3,
                ...
                container.set(DataComponents.CUSTOM_NAME,
                                Component.translatable("youzaiworldcore.message.preset.graduation_set"));
                return container;
        }
        ...
        public static ItemStack createPreset02(HolderLookup.Provider lookup) {
                ...
                container.set(DataComponents.CONTAINER, ItemContainerContents.fromItems(items));
                container.set(DataComponents.CUSTOM_NAME,
                                Component.translatable("youzaiworldcore.message.preset.graduation_supplement"));
                return container;
        }
        ...
        public static ItemStack createPreset03(HolderLookup.Provider lookup) {
                ...
                container.set(DataComponents.CONTAINER, ItemContainerContents.fromItems(items));
                container.set(DataComponents.CUSTOM_NAME,
                                Component.translatable("youzaiworldcore.message.preset.totem_box"));
                return container;
        }
        ...
        public static ItemStack createPreset04(HolderLookup.Provider lookup) {
                ...
                container.set(DataComponents.CONTAINER, ItemContainerContents.fromItems(items));
                container.set(DataComponents.CUSTOM_NAME,
                                Component.translatable("youzaiworldcore.message.preset.explosive_pack"));
                return container;
        }
         ...
         */
        public static ItemStack createPreset05(HolderLookup.Provider lookup) {
                List<ItemStack> items = new ArrayList<>();
                for (int tier = 0; tier < 3; tier++) {
                        for (int i = 0; i < 9; i++) {
                                ItemStack r = new ItemStack(Items.FIREWORK_ROCKET, 64);
                                r.set(DataComponents.FIREWORKS, new Fireworks(tier + 1, List.of()));
                                items.add(r);
                        }
                }

                ItemStack container = new ItemStack(Items.DYED_SHULKER_BOX.pick(DyeColor.PINK));
                container.set(DataComponents.CONTAINER, ItemContainerContents.fromItems(items));
                container.set(DataComponents.CUSTOM_NAME,
                                Component.translatable("youzaiworldcore.message.preset.firework_rockets"));
                return container;
        }
         ...
         */
        public static ItemStack createPreset06(HolderLookup.Provider lookup) {
                List<ItemStack> items = new ArrayList<>();

                // 三种重锤：风爆 I / II / III
                items.add(ench(Items.MACE, lookup,
                                Enchantments.DENSITY, 5, Enchantments.BREACH, 4, Enchantments.WIND_BURST, 1,
                                Enchantments.UNBREAKING, 3, Enchantments.MENDING, 1));

                items.add(ench(Items.MACE, lookup,
                                Enchantments.DENSITY, 5, Enchantments.BREACH, 4, Enchantments.WIND_BURST, 2,
                                Enchantments.UNBREAKING, 3, Enchantments.MENDING, 1));
                ...
                items.add(ench(Items.DIAMOND_CHESTPLATE, lookup,
                                Enchantments.PROTECTION, 4, Enchantments.FIRE_PROTECTION, 4,
                                Enchantments.PROJECTILE_PROTECTION, 4,
                                Enchantments.UNBREAKING, 3, Enchantments.MENDING, 1));

                items.add(ench(Items.DIAMOND_LEGGINGS, lookup,
                                Enchantments.PROTECTION, 4, Enchantments.FIRE_PROTECTION, 4,
                                Enchantments.PROJECTILE_PROTECTION, 4, Enchantments.SWIFT_SNEAK, 3,
                                Enchantments.UNBREAKING, 3, Enchantments.MENDING, 1));

                items.add(ench(Items.DIAMOND_BOOTS, lookup,
                                Enchantments.PROTECTION, 4, Enchantments.FIRE_PROTECTION, 4,
                                Enchantments.PROJECTILE_PROTECTION, 4, Enchantments.FEATHER_FALLING, 4,
                                Enchantments.DEPTH_STRIDER, 3,
                                Enchantments.SOUL_SPEED, 3,
                ...
                ItemStack container = new ItemStack(Items.DYED_SHULKER_BOX.pick(DyeColor.LIGHT_BLUE));
                container.set(DataComponents.CONTAINER, ItemContainerContents.fromItems(items));
                container.set(DataComponents.CUSTOM_NAME,
                                Component.translatable("youzaiworldcore.message.preset.mace_set"));
                return container;
        }
         ...
         */
        public static ItemStack createPreset07(HolderLookup.Provider lookup) {
                List<ItemStack> items = new ArrayList<>();
                for (int i = 0; i < 27; i++) {
                        items.add(new ItemStack(Items.EXPERIENCE_BOTTLE, 64));
                }

                ItemStack container = new ItemStack(Items.DYED_SHULKER_BOX.pick(DyeColor.LIME));
                container.set(DataComponents.CONTAINER, ItemContainerContents.fromItems(items));
                container.set(DataComponents.CUSTOM_NAME,
                                Component.translatable("youzaiworldcore.message.preset.experience_bottles"));
                return container;
        }
         ...
         */
        public static ItemStack createPreset08(HolderLookup.Provider lookup) {
                List<ItemStack> items = new ArrayList<>();
                for (int i = 0; i < 27; i++) {
                        items.add(new ItemStack(Items.ENDER_PEARL, 64));
                }

                ItemStack container = new ItemStack(Items.DYED_SHULKER_BOX.pick(DyeColor.GREEN));
                container.set(DataComponents.CONTAINER, ItemContainerContents.fromItems(items));
                container.set(DataComponents.CUSTOM_NAME,
                                Component.translatable("youzaiworldcore.message.preset.ender_pearls"));
                return container;
        }
        ...
        public static ItemStack createPreset09(HolderLookup.Provider lookup) {
                ...
                String[] potionIds = {
                                ...
                                "strong_harming",
                                "strong_poison", "strong_strength", "strong_turtle_master",
                                "long_night_vision", "long_invisibility", "long_leaping",
                                "long_fire_resistance", "long_swiftness", "long_slowness",
                                "long_water_breathing", "long_poison", "long_strength", "long_weakness",
                                "long_turtle_master", "long_slow_falling",
                                "luck", "oozing", "infested", "wind_charged", "weaving"
                };
                ...
                for (String id : potionIds) {
                        ...
                        reg.get(key).ifPresent(holder -> {
                                ...
                                arrow.set(DataComponents.POTION_CONTENTS, new PotionContents((Holder<Potion>) holder));
                                items.add(arrow);
                        });
                }

                ItemStack container = new ItemStack(Items.DYED_SHULKER_BOX.pick(DyeColor.LIGHT_GRAY));
                container.set(DataComponents.CONTAINER, ItemContainerContents.fromItems(items));
                container.set(DataComponents.CUSTOM_NAME,
