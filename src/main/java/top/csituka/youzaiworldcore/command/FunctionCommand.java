 ...
 * <li>{@code crop_xp_drop} — 农作物收获经验掉落</li>
 ...
 * </ul>
 * 省略参数 = 查询；带 true/false = 设置。
 * 查询需 {@code youzaiworldcore.command.function.query}（默认所有人），
 * 设置需 {@code youzaiworldcore.command.function.set}（默认 OP 4）。
 * </p>
 */
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        dispatcher.register(Commands.literal("yzwc")
                .then(Commands.literal("function")
                        ...
                        .then(functionNode("crop_xp_drop"))
