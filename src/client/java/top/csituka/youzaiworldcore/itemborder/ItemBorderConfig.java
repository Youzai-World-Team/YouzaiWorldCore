 ...
 * <td>manualBorders</td>
 * <td>硬编码</td>
 * <td>三组预设稀有度分配（~60 项）</td>
 * </tr>
 * </table>
 *
 * <p>
 * 该功能参考了 ItemBorders（anthonyhilyard）的设计理念，为物品槽位绘制
 * 稀有度渐变色边框。本实现完全使用 26.2 的原生 API（GuiGraphicsExtractor 管线、
 * vanilla ItemStack.getRarity），无任何外部依赖。
 * </p>
 */
...
public final class ItemBorderConfig {
     ...
     * value — 匹配该颜色的物品 ID 列表（如
     * {@code ["minecraft:diamond_sword", "minecraft:netherite_chestplate"]}）。
     * </p>
     * <p>
