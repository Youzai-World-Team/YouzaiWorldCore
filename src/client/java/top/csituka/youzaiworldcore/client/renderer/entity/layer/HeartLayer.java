...
/**
 * 心脏层 — 使用 warden_heart.png
 */
public class HeartLayer extends GeoRenderLayer<ChickenWardenAnimatable, net.minecraft.world.entity.monster.warden.Warden, WardenRenderState> {

    private static final Identifier TEXTURE = Identifier.parse("youzaiworldcore:textures/entity/warden/warden_heart.png");

    public HeartLayer(GeoRenderer<ChickenWardenAnimatable, net.minecraft.world.entity.monster.warden.Warden, WardenRenderState> renderer) {
        super(renderer);
    }
