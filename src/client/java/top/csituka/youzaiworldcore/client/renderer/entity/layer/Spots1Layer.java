...
/**
 * 脉冲斑点层1 — 使用 warden_pulsating_spots_1.png 动态闪烁
 */
public class Spots1Layer extends GeoRenderLayer<ChickenWardenAnimatable, net.minecraft.world.entity.monster.warden.Warden, WardenRenderState> {

    private static final Identifier TEXTURE = Identifier.parse("youzaiworldcore:textures/entity/warden/warden_pulsating_spots_1.png");

    public Spots1Layer(GeoRenderer<ChickenWardenAnimatable, net.minecraft.world.entity.monster.warden.Warden, WardenRenderState> renderer) {
        super(renderer);
    }
